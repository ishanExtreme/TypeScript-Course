...
export default function Navbar(props:{user:user}) {
    ...
    <ul className="navbar-nav flex flex-col pl-0 list-style-none mr-auto w-[90%] justify-center">
        <li className="nav-item p-2">
            <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/">
                Home
            </Link>
        </li>
        <li className="nav-item p-2">
            <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/list">
                Forms List
            </Link>
        </li>
        <li className="nav-item p-2">
            {props.user?
                <a className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" onClick={logout} href="/">
                    Logout
                </a>
                :
                <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" href="/login">
                    Login
                </Link>
            }
        </li>
